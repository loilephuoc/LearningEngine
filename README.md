...
- **Instructional Decision Engine**: [`docs/INSTRUCTIONAL_DECISION_ENGINE.md`](docs/INSTRUCTIONAL_DECISION_ENGINE.md)
- **Architecture Audit v1.0**: [`docs/ARCHITECTURE_AUDIT_V1.md`](docs/ARCHITECTURE_AUDIT_V1.md)
