...
internal fun typedModeMediaRole(listening: Boolean, feedbackVisible: Boolean): StudyMediaRole = when {
    listening -> StudyMediaRole.COMPACT
    feedbackVisible -> StudyMediaRole.COMPACT
    else -> StudyMediaRole.SUPPORTING
}
