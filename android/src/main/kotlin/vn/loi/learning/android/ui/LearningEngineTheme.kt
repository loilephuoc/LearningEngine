...
val LearningEngineLightColors = lightColorScheme(
    ...
    surfaceContainer = Color(0xFFEBF4EE),
    surfaceContainerHigh = Color(0xFFE2EEE6),
    surfaceContainerHighest = Color(0xFFD9E7DE),
...
val LearningEngineDarkColors = darkColorScheme(
    ...
    surfaceContainerLowest = Color(0xFF091011),
    surfaceContainerLow = Color(0xFF162325),
    surfaceContainer = Color(0xFF1C2D2F),
    surfaceContainerHigh = Color(0xFF233739),
    surfaceContainerHighest = Color(0xFF2C4345),
