...
fun ContentHost(
    ...
    onEasy: () -> Unit,
    onManualRatingOverride: (vn.loi.learning.domain.study.memory.model.ReviewRating) -> Unit,
    onManualEvaluation: (vn.loi.learning.domain.study.memory.model.ReviewRating) -> Unit,
