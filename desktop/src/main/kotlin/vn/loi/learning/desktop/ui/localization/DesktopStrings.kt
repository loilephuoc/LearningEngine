        ...
        DesktopStrings(
            ...
            studyWorkspace = StudyWorkspaceStrings(
                ...
                learningEntry = vn.loi.learning.desktop.ui.study.LearningEntryStrings(
                    ...
                    replay = "Ôn lại phiên vừa học",
                    replayAvailableDescription = { count -> "Ôn lại $count item đã được đánh giá trong phiên hoàn tất gần nhất." },
                    replayUnavailableDescription = "Chưa có phiên hoàn tất phù hợp trong phạm vi hiện tại.",
