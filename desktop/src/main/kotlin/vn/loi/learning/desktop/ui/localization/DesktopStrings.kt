    ...
    private val english =
        DesktopStrings(
            ...
            learningContent = LearningContentRendererStrings(
                ...
                "Your answer", "Correct", "Not an exact match",
                "No answer entered",
                "Learning flow",
    ...
    private val vietnamese =
        DesktopStrings(
            ...
            studyWorkspace = StudyWorkspaceStrings(
                ...
                typingSuccessAccessibility = "Thành công",
                ...
                typingLegendHard = { threshold -> "Từ $threshold" },
                typingLegendGood = { easy, hard -> "Trên $easy, dưới $hard" },
                ...
                learningEntry = vn.loi.learning.desktop.ui.study.LearningEntryStrings(
                    ...
                    currentContext = "Phạm vi học hiện tại",
                    generalScope = "Gói hoặc chủ đề hiện tại",
                    lessonScope = "Bài học đã chọn",
                    noContextTitle = "Chưa có phạm vi học đang hoạt động",
                    noContextDescription = "Chọn một gói đang hoạt động hoặc bài học trong Thư viện trước khi bắt đầu.",
                    readiness = "Sẵn sàng học",
                    resumable = "Phiên đang hoạt động",
                    newAvailable = "Mới",
                    reviewAvailable = "Ôn tập",
                    learnedAvailable = "Đã học",
                    resume = "Tiếp tục phiên đang học",
                    resumeDescription = "Tiếp tục đúng item và queue của phiên đang hoạt động.",
                    continueStudy = "Học tiếp",
                    continueDescription = "Bắt đầu Study thông thường với cấu hình phiên hiện tại.",
                    startNewConfigured = "Bắt đầu phiên mới theo cấu hình hiện tại",
                    startNewConfiguredDescription = { newLimit, reviewLimit -> "Tạo phiên mới với tối đa $newLimit từ New và $reviewLimit từ Review." },
                    startNewConfiguredFallbackDescription = "Tạo phiên mới theo giới hạn New và Review hiện tại.",
                    reviewLatestNew = "Ôn từ New của phiên vừa học",
                    reviewLatestNewAvailableDescription = { count -> "Ôn lại $count từ New đã học trong phiên hoàn tất gần nhất." },
                    reviewLatestNewUnavailableDescription = "Phiên hoàn tất gần nhất không có từ New để ôn lại.",
                    reviewAgainHard = "Ôn những từ Again / Hard",
                    reviewAgainHardAvailableDescription = { count -> "Ôn $count từ có đánh giá gần nhất là Again hoặc Hard." },
                    reviewAgainHardUnavailableDescription = "Không có từ nào có đánh giá gần nhất là Again hoặc Hard.",
                    reviewAll = "Ôn lại tất cả đã học",
                    reviewAllAvailableDescription = { count -> "Ôn toàn bộ $count item đã học trong phạm vi hiện tại." },
                    reviewAllUnavailableDescription = "Chưa có item đã học để ôn lại.",
                    backToLibrary = "Quay lại Thư viện",
                    backToLibraryDescription = "Đổi gói hoặc bài học, nhập nội dung, hoặc quản lý Thư viện.",
                    primaryActions = "Hành động học chính",
                    alternativeActions = "Cách học thay thế",
                    managementActions = "Quản lý nội dung"
                ),
