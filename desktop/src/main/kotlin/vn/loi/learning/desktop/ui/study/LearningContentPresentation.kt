...
data class LearningContentRendererStrings(
    ...
    val typingInputLabel: String = "Type the English answer",
    ...
    val typingDifferences: String = "Differences",
    val typingCorrectSuccess: String = "Correct!",
    val typingIncorrectTitle: String = "Not quite yet",
    val typingIncorrectGuidance: String = "You can keep editing.",
