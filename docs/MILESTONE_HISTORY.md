...
| Workflow Foundation Refinement | `611ac0e` | `develop` | 2026-07-22 | Completed | Made `AGENTS.md` the sole workflow authority and separated strategic handoff, operational context, roadmap, architecture, changelog, and milestone history responsibilities. |
| Desktop Runtime Foundation | `1096f8e` | `develop` | 2026-07-22 | Completed | Established stable identity/build metadata, platform runtime directories, non-destructive typed config, retained file logging, deterministic lifecycle, and redacted About/support diagnostics. |
| Desktop UX Foundation | `82b5278` | `develop` | 2026-07-22 | Completed | Standardized shell/navigation, safe window restart, theme and locale Settings, English/Vietnamese shell localization, focus traversal, startup presentation, and runtime-backed About dialog. |
