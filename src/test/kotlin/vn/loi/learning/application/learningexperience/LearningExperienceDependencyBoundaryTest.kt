...
class LearningExperienceDependencyBoundaryTest {
    ...
    fun `shared experience API exposes no Desktop Compose or filesystem types`() {
        val sharedTypes = listOf(
            ...
            ExperienceSelectionProfile::class.java,
            ExperienceRotationContext::class.java,
            RoundRobinExperienceStrategy::class.java,
            UserChoiceExperienceStrategy::class.java,
            TypingRecallPrompt::class.java,
            TypingRecallPromptExtractor::class.java,
            TypingAnswerEvaluationStatus::class.java,
            TypingAnswerEvaluation::class.java,
            TypingAnswerEvaluator::class.java
        )
